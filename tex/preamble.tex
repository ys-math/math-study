...
% \DocTitle is defined by main.tex *after* this file is \input, so the metadata
% has to wait until it exists. pdflang is deliberately absent: hyperref's luatex
% driver does not emit /Lang, and the \DocumentMetadata route that would is
% fatal here — it sends keytheorems into an infinite loop at \declaretheorem.
