...
$(R, +_R, \cdot_R)$を環とし$(M, +)$をアーベル群とする.\ $\cdot \colon R \times M \to M$を写像とする.\ 次が成り立つとき$(M, +, \cdot)$を$R$\term[R-module]{かぐん}{加群}{$R$-module}という.
...
$(R, +_R, \cdot_R)$を環とし$(M, +_M, \cdot_M), (N, +_N, \cdot_N)$を$R$加群とする.\ 写像$f \colon M \to N$が次を満たすとき$f$は$R$\term[R-linear map]{せんけいしゃぞう}{線形写像}{$R$-linear map}であるという.
\def\labelenumi{(\theenumi)\hspace{.5\zw}}
\begin{enumerate}
...
$R$を環とする.\ $R$加群$R$の部分$R$加群を$R$の\term{いである}{イデアル}{ideal}という.
\end{definition}
...
$R$を環とし$\mathfrak{p}$を$R$のイデアルとする.\ 剰余環$R/\mathfrak{p}$が整域であるとき$\mathfrak{p}$は$R$の\term{そいである}{素イデアル}{prime ideal}であるという.
\end{definition}
...
$R$を環とし$\mathfrak{m}$を$R$のイデアルとする.\ 剰余環$R/\mathfrak{m}$が体であるとき$\mathfrak{m}$は$R$の\term{きょくだいいである}{極大イデアル}{maximal ideal}であるという.
\end{definition}
...
\begin{definition}
$R$を環とし$I$を$R$のイデアルとする.\ $\sqrt{I} \coloneq \{r \in R \mid {^{\exists}n} \in \mathbb{N} \setminus 1,\ r^n \in I\}$とすると$\sqrt{I}$は$R$のイデアルになる.\ これを$I$の\term{こんき}{根基}{radical}という.
\end{definition}
