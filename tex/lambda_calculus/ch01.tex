...
\begin{definition}
$V$を可算集合とし$V$の元を\term{へんすう}{変数}{variable}と呼ぶことにする.\ $\Lambda$を次の条件を満たす最小の集合とする.
\begin{itemize}
...
\end{center}
$\to_\alpha$を\term[alpha-step]{あるふぁすてっぷ}{$\alpha$ステップ}{$\alpha$-step}と呼ぶ.\ つまり$x,y \in V, M \in \Lambda, y \notin \textrm{Ver}(M)$に対して
\begin{center}
