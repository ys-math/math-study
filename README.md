...
<!-- BEGIN TEXT METER -->
```
category_theory          ███████████▏░░░░░░░░   55.9%  50,249
algebraic_k_theory       ████░░░░░░░░░░░░░░░░   19.9%  17,859
lambda_calculus          ██▎░░░░░░░░░░░░░░░░░   11.3%  10,197
commutative_ring_theory  █▍░░░░░░░░░░░░░░░░░░    7.1%   6,358
homological_algebra      ▉░░░░░░░░░░░░░░░░░░░    4.3%   3,839
topology                 ▏░░░░░░░░░░░░░░░░░░░    0.8%     694
manifold                 ▏░░░░░░░░░░░░░░░░░░░    0.6%     573
...
| `python scripts/lean_statements.py status [<topic> [<chapter>]]` | Reports each Lean statement file's read-back state — unread, stale, unaudited, audited. `/read-back` runs its `prepare` and `assemble` halves; see `docs/lean-convention.md`, `## Read-back` |
...
| `/bib <topic> <citation>` | Files a reference you supply into `tex/<topic>/bibliography.tex` per `docs/bib-convention.md`, creating that file and `\input`ing it from `main.tex` before the colophon when the topic has none. It inserts no `\cite{}` — the citation is yours, and so is the sentence that cites it |
| `/formalize <topic> <chapter> [label ...]` | Translates one chapter's labelled theorems, and the definitions they need, into `lean/Math/Study/<Topic>/C<NN>.lean` as Lean statements proved by `sorry`, reusing the label body as the declaration name. The file is frozen once written; your proofs go in `lean/Math/Proof/<Topic>/C<NN>.lean`, pinned to each statement by `type_of%`. It never writes a proof |
| `/read-back [<topic> <chapter>]` | Has a reader that has never seen your notes turn that chapter's elaborated Lean statements back into literal English, filed as `C<NN>.readback.tex` beside them, with a stamp per declaration. You compare it with the chapter and set `audited=yes`; a changed statement loses its audit. With no arguments, shows every chapter's audit state |
