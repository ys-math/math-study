...
\end{center}
が成り立つ.
% https://q.uiver.app/#q=
\[\begin{tikzcd}
	M & {N_1} \\
	{N_2} & {N_3}
	\arrow["\beta", two heads, from=1-1, to=1-2]
	\arrow["\beta"', two heads, from=1-1, to=2-1]
	\arrow["\beta", two heads, from=1-2, to=2-2]
	\arrow["\beta", two heads, from=2-1, to=2-2]
\end{tikzcd}\]
\hfill $\square$
\end{theorem}